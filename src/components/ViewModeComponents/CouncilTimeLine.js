...
export default function CouncilTimeLine({ councils }) {
            ...
            <Accordion expanded={expanded}>
                ...
                <AccordionDetails>
                    <Box sx={{
                                    ...
                                    >
                                        {
                                            councils.map((council, index) => {
                                                return (<TimelineItem  key={council._id} >

                                                            <TimelineSeparator>
                                                                <TimelineDot color='success' />
                                                            </TimelineSeparator>
                                                            <TimelineContent sx={{ paddingBottom: 3 }}>
                                                                <ItemCouncil council={council} />
                                                            </TimelineContent>
                                                        </TimelineItem>)
                                            })
                                        }
                        ...
                        {
                            councils.length == 0 && <Typography align='center'>No Councils added yet.</Typography>
                        }
                    </Box>
                </AccordionDetails>
            </Accordion>
