...
export default function ItemJournal({ journal }) {
  ...
  return (
    ...
    >
      <Box sx={{ flexGrow: 1 }}>
        ...
        {!_.isEmpty(journal.journal) ? (
          <Typography display="inline" sx={{ fontStyle: 'italic' }}>
            {' '}
            , {journal.journal}{' '}
          </Typography>
        ) : null}
        {!_.isEmpty(journal.vol) ? (
          <Typography display="inline" sx={{ fontStyle: 'italic' }}>
            {' '}
            , Vol - {journal.vol}{' '}
          </Typography>
        ) : null}
        {!_.isEmpty(journal.issue) ? (
          <Typography display="inline" sx={{ fontStyle: 'italic' }}>
            {' '}
            , Issue - {journal.issue}{' '}
          </Typography>
        ...
        {!_.isEmpty(journal.page_range) ? (
          <Typography display="inline">
            {' '}
            , pages {journal.page_range}{' '}
          </Typography>
        ) : null}
