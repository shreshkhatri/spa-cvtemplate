...
export default function EditAwardHonorForm({
  open,
  setOpen,
  award,
  editAwardHonor,
  ...
  const [awardDate, setAwardDate] = useState(
    award.award_date ? dayjs(award.award_date) : award.award_date
  );
  ...
  useEffect(() => {
    ...
    setAwardDate(award.award_date ? dayjs(award.award_date) : award.award_date);
  }, [award]);
