...
export default function EditCommitteeForm({
  ...
  const [startDate, setStartDate] = useState(
    committee.start_date ? dayjs(committee.start_date) : committee.start_date
  );
  const [endDate, setEndDate] = useState(
    committee.end_date ? dayjs(committee.end_date) : committee.end_date
  );
