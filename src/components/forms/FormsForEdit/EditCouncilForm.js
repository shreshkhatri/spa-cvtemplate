...
export default function EditCouncilForm({
  open,
  setOpen,
  council,
  editCouncil,
  ...
  const [startDate, setStartDate] = useState(
    council.start_date ? dayjs(council.start_date) : council.start_date
  );
  const [endDate, setEndDate] = useState(
    council.end_date ? dayjs(council.end_date) : council.end_date
  );
  ...
  useEffect(() => {
    ...
    setEndDate(council.end_date ? dayjs(council.end_date) : council.end_date);
